...
import type { typeType, contentType, payloadType, positionCursorType, iCreateTreeType, treeType, callBackType, childInTreeType, editorSwitchToolTypes, editorUpdateTreeType } from "../types/component.markDownEditor.type";
...
export default class EditorWizard {
  ...
  activeTools({ tree, positionCursor }: { tree?: any; positionCursor?: positionCursorType }): childInTreeType[] {
