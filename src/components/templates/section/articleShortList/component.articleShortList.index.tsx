...
export default function SectionArticleShortList({ data, type, loadData, search, userId = 0, tagId = 0 }: { data: any; type: string; loadData?: boolean; search?: string; userId?: number; tagId?: number }): JSX.Element {
