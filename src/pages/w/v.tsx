...
const WaitingroomVideo: NextPage<any, ContentType> = ({ tag, content }: { tag: TagWithOnlyTitleType; content: ContentType }) => {
    ...
    <>
      ...
      <Container>
        <Row>
          ...
          />
          <Col xs={12} md={9}>
            <ListShortArticle data={content} type="videoWaitingRoom" />
          </Col>
        </Row>
      </Container>
    </>
