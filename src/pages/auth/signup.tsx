...
const SingUp: NextPage<any, TagWithOnlyTitleType> = ({ tag, countUser }: { tag: TagWithOnlyTitleType; countUser: CountUserType }): JSX.Element => {
    ...
    <>
      ...
      <Container>
        <Row>
          ...
          <Col xs={12} md={9}>
            <SectionSingUp users={countUser.user.meta.pagination.total} />
          </Col>
        </Row>
      </Container>
    </>
