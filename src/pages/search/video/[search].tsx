...
const SearchVideo: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Wyniki wyszukiwania video dla : {search} | POLSKI.DEV 👩‍💻👨‍💻</title>
      </Head>
      <Container>
        <Row>
          <MenuPrimary
          ...
          />
          <Col xs={12} md={9}>
            <ListShortArticle data={data} type="searchVideo" loadData={loadData} search={search?.toString()} />
          </Col>
        </Row>
      </Container>
    </>
