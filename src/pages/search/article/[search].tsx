...
const SearchArticle: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Wyniki wyszukiwania artykułów dla : {search} | POLSKI.DEV 👩‍💻👨‍💻</title>
      </Head>
      <Container>
        <Row>
          <MenuPrimary
          ...
          />
          <Col xs={12} md={9}>
            <ListShortArticle data={data} type="searchArticle" loadData={loadData} search={search?.toString()} />
          </Col>
        </Row>
      </Container>
    </>
