import { contentGetPreview, contentInitialState } from "database/database.graphQL.index";
...
export default async function contentAPI(req: any, res: any): Promise<void> {
  ...
  res.status(200).json(await contentGetPreview(parseInt(page), waitingroom));
}
