...
export default async function handler(req: any, res: any) {
  ...
  const response = await fetch(
    `${process.env.URL_API}/api/videos?pagination[page]=${q}&pagination[pageSize]=10&populate=cover&populate=tags&populate=author&filters[waitingroom][$eq]=false&sort[1]=views%3Adesc&filters[createdAt][$gt]=${startDate}&filters[createdAt][$lt]=${endDate}`
  );
