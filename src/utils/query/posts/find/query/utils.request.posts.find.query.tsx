...
export async function postsFindBackEnd({ published = true, typ = ContentEnum.post, page = 1, authorId }: { published?: boolean; typ?: ContentEnum; page?: number; authorId?: number }) {
...
export async function postsFindFrontEnd({ published = true, typ = ContentEnum.post, page = 1 }: { published?: boolean; typ?: ContentEnum; page?: number }) {
